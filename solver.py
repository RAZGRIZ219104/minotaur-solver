...
_PYMSNO_NAME = "pymsno-mvcover-raptor-47"  # __PYMSNO_NAME__
_PYMSNO_FP = "e29745005-n1-47-razgriz"  # __PYMSNO_FP__  (rotated per submission -> unique fingerprint each round)
