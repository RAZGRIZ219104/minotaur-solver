...
_PYMSNO_NAME = "pymsno-mvcover-raptor-182"  # __PYMSNO_NAME__
_PYMSNO_FP = "e29746483-n1-182-razgriz"  # __PYMSNO_FP__  (rotated per submission -> unique fingerprint each round)
