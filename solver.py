...
_PYMSNO_NAME = "pymsno-curvegen-raptor-33"  # __PYMSNO_NAME__
_PYMSNO_FP = "e29744476-n1-33-razgriz"  # __PYMSNO_FP__  (rotated per submission -> unique fingerprint each round)
